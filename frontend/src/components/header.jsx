        ...
        <div className="flex flex-col items-center mt-20 px-4 text-center
            ...
            <h1 className="flex items-center gap-2 text-xl sm:text-3xl font-medium mb-2">
                Hey Developer <img className="w-8 aspect-square"
                 src={assets.hand_wave} alt=""></img>
            </h1>
            <h2
                className="text-3xl sm:text-5xl font-semibold mb-4">Welcome to our app
            </h2>
            <p
                className="mb-8 max-w-md">Let's start with a quick product tour and
